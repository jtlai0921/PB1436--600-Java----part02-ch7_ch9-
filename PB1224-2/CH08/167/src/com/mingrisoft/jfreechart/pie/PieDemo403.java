...
public class PieDemo403 extends ApplicationFrame {
	...
	public void createPiePlot() {
		...
		//設定餅圖邊框筆觸
		piePlot.setSectionOutlineStroke("JAVA從入門到精通（第2版）",new BasicStroke(3f));
		piePlot.setSectionOutlineStroke("視訊學JAVA", new BasicStroke(3f));
		piePlot.setSectionOutlineStroke("JAVA全能速查寶典", new BasicStroke(3f));
		piePlot.setSectionOutlineStroke("Java範例完全自學手冊(1DVD)", new BasicStroke(3f));
		piePlot.setSectionOutlineStroke("Java開發典型模塊大全", new BasicStroke(3f));
	...
	public static void main(String[] args) {
		PieDemo403 pieChartDemo1 = new PieDemo403("餅圖實例");
