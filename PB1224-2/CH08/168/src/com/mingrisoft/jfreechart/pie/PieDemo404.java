...
public class PieDemo404 extends ApplicationFrame {
	...
	public void createPiePlot() {
		...
		//設定餅圖的顏色
		piePlot.setSectionPaint("JAVA從入門到精通（第2版）", Color.black);
		piePlot.setSectionPaint("視訊學JAVA", Color.blue);
		piePlot.setSectionPaint("JAVA全能速查寶典", Color.cyan);
		piePlot.setSectionPaint("Java範例完全自學手冊(1DVD)", Color.gray);
		piePlot.setSectionPaint("Java開發典型模塊大全", Color.orange);
	...
	public static void main(String[] args) {
		PieDemo404 pieChartDemo1 = new PieDemo404("餅圖實例");
