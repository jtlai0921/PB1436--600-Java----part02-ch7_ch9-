...
public class PieDemo1 extends ApplicationFrame {
	...
	private JFreeChart getJFreeChart() {
		...
		JFreeChart chart = ChartFactory.createPieChart("2010.8月份銷售排行", dataset,true, true, false);
	...
	public void createPiePlot() {
		...
		PiePlot piePlot = (PiePlot) chart.getPlot();
		// 需要分離的圖書
		piePlot.setExplodePercent("Java範例完全自學手冊(1DVD)", 0.1);
		piePlot.setExplodePercent("JAVA全能速查寶典", 0.1);
		// 把JFreeChart面板儲存在窗體裡
	...
	public static void main(String[] args) {
		PieDemo1 pieChartDemo1 = new PieDemo1("餅圖實例");
