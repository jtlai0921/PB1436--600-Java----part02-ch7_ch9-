...
public class BarDemo33 extends ApplicationFrame {
	...
	private void updatePlot(JFreeChart chart) {
		...
		//設定註釋字體
		annotation.setFont(new Font("細明體", Font.PLAIN, 15));
		annotation1.setFont(new Font("細明體", Font.PLAIN, 15));
		annotation2.setFont(new Font("細明體", Font.PLAIN, 15));
		annotation3.setFont(new Font("細明體", Font.PLAIN, 15));
		annotation4.setFont(new Font("細明體", Font.PLAIN, 15));
		annotation5.setFont(new Font("細明體", Font.PLAIN, 15));
	...
	public static void main(String[] args) {
		BarDemo33 barDemo = new BarDemo33("柱形圖實例");
		barDemo.createPlot();
		barDemo.pack();
		// 把窗體顯示到顯示器中央
