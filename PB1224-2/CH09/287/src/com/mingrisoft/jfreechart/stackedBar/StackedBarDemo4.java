...
public class StackedBarDemo4 extends ApplicationFrame {
	...
	private CategoryDataset getCategoryDataset() {
		...
		// 行關鍵字
		final String series1 = "JAVA圖書(含光碟)";
		final String series2 = "VC圖書(含光碟)";
		final String series3 = "VB圖書(含光碟)";
		final String series11 = "JAVA圖書(無光碟)";
		final String series21 = "VC圖書(無光碟)";
		final String series31 = "VB圖書(無光碟)";
		// 列關鍵字
	...
	private JFreeChart getJFreeChart() {
		...
		JFreeChart chart = ChartFactory.createStackedBarChart("2010年上半年銷售量", // 圖表標題
				"月份", // x軸標籤
				"銷售量（單位：本）", // y軸標籤
				dataset, // 資料集
	...
	private void updatePlot(JFreeChart chart) {
        ...
        domainAxis.addSubCategory("含光碟");
        domainAxis.addSubCategory("無光碟");
        ...
        //分為兩組
        map.mapKeyToGroup("JAVA圖書(含光碟)", "G1");
        map.mapKeyToGroup("VC圖書(含光碟)", "G1");
        map.mapKeyToGroup("VB圖書(含光碟)", "G1");

        map.mapKeyToGroup("JAVA圖書(無光碟)", "G2");
        map.mapKeyToGroup("VC圖書(無光碟)", "G2");
        map.mapKeyToGroup("VB圖書(無光碟)", "G2");
	...
	public static void main(String[] args) {
		StackedBarDemo4 demo = new StackedBarDemo4("堆積條形圖");
		demo.createPlot();
		demo.pack();
		// 把窗體顯示到顯示器中央
