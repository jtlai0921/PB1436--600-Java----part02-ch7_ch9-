...
public class DualAxisDemo4 extends ApplicationFrame {
	...
	private JFreeChart getJFreeChart() {
		...
		JFreeChart chart = ChartFactory.createBarChart3D("2010年上半年銷售量", // 圖表標題
				"月份", // x軸標籤
				"銷售量（單位：本）", // y軸標籤
				dataset, // 資料集
...
//        LineAndShapeRenderer renderer2 = new LineAndShapeRenderer();
        ...
        final ValueAxis axis2 = new NumberAxis("網購銷售量");
		// y軸字體
        axis2.setTickLabelFont(new Font("細明體", Font.PLAIN, 14));
		// y軸標籤字體
        axis2.setLabelFont(new Font("細明體", Font.PLAIN, 14));
	...
	public static void main(String[] args) {
		DualAxisDemo4 demo = new DualAxisDemo4("雙軸圖");
		demo.createPlot();
		demo.pack();
		// 把窗體顯示到顯示器中央
